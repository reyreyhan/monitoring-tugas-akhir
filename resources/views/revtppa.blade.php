...
@include('include.header')
  <div class="content-wrapper">
    <div class="container-fluid">
      <!-- Breadcrumbs-->
    <h1 class="mb-3">Upload Persyaratan Revisi TPPA</h1>
        ...
        <div class="row">
          <div class="col-lg-10 col-xs-6 ">
            ...
            <div class="col-lg-12 mb-5">
              ...
              <form action="{{ url('/revtppa/store')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('post')}}
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @if($u->status == 0)
                    <td>
                      <form method="POST" action="{{url('revtppa/delete')}}/{{$u->nrp}}/{{$u->id_kategori}}/{{$u->id_jenis}}/{{$u->id}}">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
